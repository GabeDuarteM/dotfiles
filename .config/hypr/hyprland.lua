...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd(
		"uwsm app -t service -- $HOME/.config/hypr/run-in-interval.sh 900 $HOME/.config/hypr/change-wallpaper.sh"
	)
...
hl.window_rule({
	name = "jellyfin-player-tile",
	match = { class = "^(Jellyfin Media Player)$" },
	workspace = "9",
	tile = true,
})
hl.window_rule({
	name = "jellyfin-browser",
	match = { class = "^(Brave-browser)$", title = "^(Jellyfin)$" },
	workspace = "9",
})
...
hl.window_rule({
	...
	match = { class = "^(Brave-browser)$", title = "^(_crx_nngceckbapebfimnlniiiahkandclblb)$" },
	float = true,
})
hl.window_rule({
...
hl.window_rule({
	name = "battlenet-updates-float",
	match = { class = "^(battle.net.exe)$", title = "^(Battle.net Updates)$" },
	float = true,
})
...
hl.window_rule({
	name = "syncthingtray-float",
	match = { class = "^(syncthingtray)$" },
	float = true,
	stay_focused = true,
})
hl.window_rule({
	name = "dolphin-new-folder-dialog",
	match = { initial_title = "^(Create New Folder — Dolphin)$" },
	stay_focused = true,
})
...
hl.window_rule({
	name = "dolphin-copy-dialog-float",
...
hl.window_rule({
	name = "google-meet-popout",
	match = { class = "^(brave-browser)$", initial_title = "^(Meet - .*)$" },
	float = true,
	pin = true,
})
